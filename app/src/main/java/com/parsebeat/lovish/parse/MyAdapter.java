...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    MyAdapter(String[] titles, TypedArray icons, Context context) {
        ...
        public void onClick(View v) {
            ...
            switch (getPosition()) {
                case 1:
                    ...
                    fragmentTransaction.replace(R.id.container, main_fragment, main_fragment.getTag());
                    fragmentTransaction.addToBackStack(null);
                    fragmentTransaction.commit();
                    break;
                case 2:
                    Fragment shows_fragment = new Shows_Fragment();
                    fragmentTransaction.replace(R.id.container, shows_fragment, shows_fragment.getTag());
                    fragmentTransaction.addToBackStack(shows_fragment.getTag());
                    fragmentTransaction.commit();
                    break;
                case 3:
                    Fragment profile = new ProfileFragment();
                    fragmentTransaction.replace(R.id.container, profile, profile.getTag());
                    fragmentTransaction.addToBackStack(profile.getTag());
                    fragmentTransaction.commit();
                    break;
            }
        }
