 ...
 */
public class Daily_tracks_Fragment extends Fragment {
    Toolbar toolbar;
    RecyclerView popl;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_daily_tracks, container, false);
        ...
        activity.getSupportActionBar().setTitle("Daily Rotation");
